...
## 설계 방향 (Delivery App 특화)
- 도메인: 범용 웹 광고가 아닌 배달 앱(Delivery App) 광고 로그에 특화
- 플랫폼 구분: 모바일 앱(iOS/Android) 중심으로 세분화, 웹/태블릿 보조
- 트래픽 모델: 점심/저녁 피크(최대 300%) 및 주말 수요 가중치 반영
- 지역 특성: 강남/서초 등 유동 인구 지역에 CTR 가중치 적용

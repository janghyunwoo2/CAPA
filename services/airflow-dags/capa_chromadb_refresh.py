...
⛔ 중단됨 (2026-03-21)
Airflow 기반 ChromaDB 자동 재학습 기능을 중단합니다.
피드백(👍/👎)은 DynamoDB query-history 테이블에 계속 기록되지만,
ChromaDB 재학습은 수행하지 않습니다.
재활성화 시 아래 주석을 해제하세요.
"""
...
# ------------------------------------------------------------------------------
# Task 1: pending 항목 추출 (⛔ 중단됨 — 재활성화 시 주석 해제)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# ShortCircuit: pending 항목이 없으면 후속 Task 스킵 (⛔ 중단됨 — 재활성화 시 주석 해제)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Task 2: SQL EXPLAIN 검증 + 해시 중복 제거 (⛔ 중단됨 — 재활성화 시 주석 해제)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Task 3: ChromaDB 배치 학습 (⛔ 중단됨 — 재활성화 시 주석 해제)
# ------------------------------------------------------------------------------

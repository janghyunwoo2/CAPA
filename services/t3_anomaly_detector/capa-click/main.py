"""
Real-time Ad Click Anomaly Detector - 실시간 탐지 실행부 (main.py)
...
def save_html(result: DetectionResult) -> None:
    ...
    try:
        ...
        fig.update_layout(
            title="Ad Click Anomaly Detection", 
            xaxis_title="시각", 
            yaxis_title="Click 수", 
            hovermode="x",
        ...
        with open(jsonl_path, "w", encoding="utf-8") as jsonl_file:
            for record in source:
                ...
                try:
                    ...
                    # 재훈련용 데이터 누적
                    all_records.append({"timestamp": ts, "click_count": count})

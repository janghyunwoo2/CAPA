...
CSV_DATA_PATHS = [
    os.path.join(DATA_DIR, "historical_conversion_data_202602_from_athena.csv"),
    os.path.join(DATA_DIR, "historical_data_202602_from_athena.csv"),
    os.path.join(DATA_DIR, "historical_data_202602.csv")
]
...
def load_csv_records(csv_path: str) -> list:
    ...
    records = [
        {"timestamp": row["timestamp"].to_pydatetime(), "conversion_count": int(row["conversion_count"])}

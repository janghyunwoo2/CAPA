...
| `enterprise-expert` | claude-sonnet-4-6 | 3단계 RAG 설계(FR-12), 피드백 루프(FR-16), 중복 쿼리 방지(FR-17), BackgroundTasks 아키텍처, History 전환 |
...
| §4 FR-16~17 피드백/중복 | `enterprise-expert` | FeedbackManager 수정, SQL 해시 설계 |

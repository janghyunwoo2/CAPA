...
| **참고 문서** | `docs/t1/text-to-sql/00_mvp_develop/01-plan/features/text-to-sql.plan.md` |
...
# ⚠️ 실제 Athena 테이블 기준 모델 (docs/t1/text-to-sql/00_mvp_develop/02-design/05-sample-queries.md 스키마 기준)
...
> **테이블 구조 기준**: `docs/t1/text-to-sql/00_mvp_develop/02-design/05-sample-queries.md`

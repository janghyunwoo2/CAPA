...
> **기준 문서**:
> - `docs/t1/text-to-sql/00-보고서../../00-기타/e2e-scenario.md` — 테스트 시나리오 원본
> - `docs/t1/text-to-sql/00-보고서../../00-기타/pipeline-flow-example.md` — Step별 중간 데이터 명세
> - `docs/t1/text-to-sql/00_mvp_develop/01-plan/features/text-to-sql.plan.md` — FR/NFR/SEC 요구사항
> - `docs/t1/text-to-sql/02-design/features/text-to-sql.design.md` — 설계 명세
> - `docs/t1/text-to-sql/00_mvp_develop/04-report/text-to-sql.report.md` — 구현 완료 현황
...
이 테스트 계획서는 **../../00-기타/e2e-scenario.md에 정의된 시나리오를 그대로 실행하는 것**을 목표로 한다.
...
**상세 결과**: `docs/t1/text-to-sql/00_mvp_develop/05-test/plan-phase-1-tests/phase-1-test-report.md` 참조
...
def test_refine_pipeline_flow_example_case():
    """../../00-기타/pipeline-flow-example.md 기준 케이스 (FR-02)"""
...
def test_extract_includes_domain_terms():
    ...
    # ../../00-기타/pipeline-flow-example.md 기준: ["ROAS", "device_type", "conversion_value", "최근 7일"]
...
async def test_full_pipeline_simple_query():
    """../../00-기타/pipeline-flow-example.md 기준: 어제 캠페인별 CTR (FR-01~FR-11 연결)"""
...
> **목적**: ../../00-기타/e2e-scenario.md에 정의된 시나리오를 실제 환경에서 검증
...
> **참고**: ../../00-기타/e2e-scenario.md §1, ../../00-기타/pipeline-flow-example.md 전체
...
```bash
# 기대 응답 구조 (../../00-기타/e2e-scenario.md §1-3 기준)
...
# 기대 응답 (../../00-기타/e2e-scenario.md §1 시나리오B)
# {
#   "status": "accepted",
#   "trained": true,
...
# ../../00-기타/e2e-scenario.md + ../../00-기타/pipeline-flow-example.md 기준 테스트 케이스
TEST_CASES = [
    {
        "question": "어제 캠페인별 CTR 알려줘",
        # ../../00-기타/e2e-scenario.md Step 5 기대 SQL
        "expected_sql": """
            SELECT
              campaign_id,
    ...
    },
    {
        ...
        # ../../00-기타/pipeline-flow-example.md Step 5 기대 SQL
        "expected_sql": """
            SELECT
              device_type,

...
> **기준 문서**:
> - `docs/t1/text-to-sql/00_mvp_develop/05-test/plan-phase-1-tests/test-plan.md` — 원본 테스트 계획서 (Phase 2 참조)
> - `docs/t1/text-to-sql/00_mvp_develop/05-test/plan-phase-1-tests/phase-3-prerequisites-report.md` — Phase 3 미해결 이슈 목록
